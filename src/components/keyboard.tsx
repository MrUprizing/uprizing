/** biome-ignore-all lint/a11y/noStaticElementInteractions: <Svg UI> */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: <Svg UI> */
  ...
  ({
    ...
    return (
      <div
        ...
        className="flex w-[700px] flex-col gap-2 rounded-md p-2 text-muted-foreground dark:text-muted-foreground"
      >
...
const IconKeyboardKey = memo(
  ({
    ...
    return (
      <motion.div
        variants={{
          initial: { borderColor: "rgba(0, 0, 0, 0.2)" },
          animate: {
            borderColor: [
              "rgba(0, 0, 0, 0.2)",
              "rgba(0, 0, 0, 0.35)",
        ...
        style={{
          ...
          color: data.shouldGlow ? `${glowColor}50` : "currentColor",
        }}
        className={cn(
          className,
          data.shouldGlow
            ? "animate-[6000ms] glowing-key"
            : "hover:border-muted dark:hover:border-white/20",
          "shadow-[inset_0px_0px_15px_rgba(0,0,0,0.2)] dark:shadow-[inset_0px_0px_15px_rgba(0,0,0,0.4)] group relative flex select-none flex-col items-center justify-center gap-1.5 rounded-md border border-x-[1px] border-b-[0.1px] border-t-[1.5px] border-muted/40 dark:border-white/10 px-2 duration-200 first:items-start last:items-end active:!scale-[0.98]",
          "bg-white/5 dark:bg-white/5",
        )}
      >
        {!isSingleKey && (
          <div className="mt-0.5 h-[10px] w-[10px] text-center text-xs font-light text-muted-foreground/50 dark:text-muted-foreground/60 duration-200 group-hover:text-muted-foreground/80 dark:group-hover:text-muted-foreground">
            {icon}
          </div>
        )}
        <div
          ...
          className={cn(
            ...
            "text-center text-muted-foreground/60 dark:text-muted-foreground/70 duration-200 group-hover:text-muted-foreground/90 dark:group-hover:text-white/60",
          )}
        >
          {data.text}
        </div>
  ...
  ({
    ...
    return (
      <motion.div
        ...
        className={cn(
          "shadow-[inset_0px_0px_15px_rgba(0,0,0,0.2)] dark:shadow-[inset_0px_0px_15px_rgba(0,0,0,0.4)] group relative flex flex-col items-center justify-center gap-1.5 rounded-md border border-x-[1px] border-b-[0.1px] border-t-[1.5px] border-muted/40 dark:border-white/10 duration-200 hover:border-muted dark:hover:border-white/20",
          "bg-white/5 dark:bg-white/5",
        )}
      >
        <div className="shadow-[inset_0px_0px_2px_rgba(0,0,0,0.6)] dark:shadow-[inset_0px_0px_2px_rgba(0,0,0,0.8)] h-8 w-8 rounded-full bg-muted/15 dark:bg-white/5 duration-200 group-hover:bg-muted/25 dark:group-hover:bg-white/10" />
      </motion.div>
    );
  },
);
