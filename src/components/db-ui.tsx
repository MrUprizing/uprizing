...
const DatabaseWithRestApi = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[300px] w-full max-w-[500px] flex-col items-center",
        className,
      )}
    >
      {/* SVG Paths  */}
      <svg
        ...
        viewBox="0 0 200 100"
      >
        <title>Database with REST API</title>
        <g
          stroke="currentColor"
          fill="none"
          strokeWidth="0.4"
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        {/* box title */}
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded border bg-card px-2 py-1 sm:-top-4 sm:py-1.5">
        ...
        {/* box outter circle */}
        <div className="absolute -bottom-8 z-30 grid h-[60px] w-[60px] place-items-center rounded-full border-t bg-card font-semibold text-xs border">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          ...
          <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-card px-3 text-xs border flex items-center gap-2">
            ...
            <span>{buttonTexts?.first || "MrUprizing"}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 rounded-full bg-card px-3 text-xs sm:flex border items-center gap-2">
