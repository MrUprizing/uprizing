...
export function ProjectArchitecturFlow({ className }: { className?: string }) {
  ...
  return (
    <div className="w-full overflow-x-auto md:overflow-visible">
      <div
        className={cn(
          "relative flex h-[420px] w-full items-center justify-center overflow-hidden p-2 md:p-10 min-w-[500px] md:min-w-full",
          className,
        )}
        ref={containerRef}
      >
        <div className="flex size-full max-w-6xl flex-row items-stretch justify-between gap-1 md:gap-10">
